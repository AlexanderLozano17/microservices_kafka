...
public class KafkaConsumerConfig {
	...
	@Bean
	public ConcurrentKafkaListenerContainerFactory<String, ResponseKafka<Person>> responseKafkaListenerContainerFactory() {
	    ConcurrentKafkaListenerContainerFactory<String, ResponseKafka<Person>> factory = new ConcurrentKafkaListenerContainerFactory<>();
